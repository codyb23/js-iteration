...
const onlyTheEvenIndexedSurvive = array => {
  return array.filter((data, index) => index % 2 === 0)
}
// ...
...
const everyoneIsOdd = array => {
  return array.every(odds => odds % 2 === 1)
}
// ...
...
const findTheNeedle = array => {
  return array.find(phrase => phrase.includes('needle'))
}
// ...
...
const findTheNeedleIndex = array => {
  return array.findIndex(index => index.includes('needle'))
}
// ...
...
const someoneToLove = array => {
  return array.some(phrase => phrase.length === 4)
}
// ...
